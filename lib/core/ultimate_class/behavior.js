var behaviorMethods = {
	...
	emit: function(eventName) {
		var args = _.toArray(arguments),
			...
			console.log('LISTENERS', this.className, eventName, this.listeners(eventName)); 
			
		var callNext = _.applyNext(this.listeners(eventName), this, args);
		if(callNext !== false) callNext = _.invokeNextApply(this.getBehaviors(), 'emit', null, args);
