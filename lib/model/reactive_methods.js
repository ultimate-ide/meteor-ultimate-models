UltimateModel.extend({
	...
	clearReactive: function(reactiveId) {
		reactiveId = reactiveId.replace('ultimate_model_reactive_', ''); //remove prefix so clearReactive('some_id') can be called by client code
	...
	_prefixReactiveId: function(reactiveId) {
		var prefix = 'ultimate_model_reactive_';
