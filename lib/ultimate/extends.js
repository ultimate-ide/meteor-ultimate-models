_.extend(Ultimate, {
  extends: function (Parent, methods, staticMethods, httpMethods, staticHttpMethods) {
    ...
    console.log("PARENT 1", this.className, this.parent && this.parent.className);
    this.configureStatics();

    console.log("PARENT 2", this.className, this.parent && this.parent.className);
    ...
    if(Class.className != 'UltimateClone') Class.emitStart(); //only UltimateClone, the first extended class, won't have these yet
  ...
  attachBehaviors: function() {
    if(this.class.behaviors) this.class.attachBehaviors(this.class.behaviors); 
  },
