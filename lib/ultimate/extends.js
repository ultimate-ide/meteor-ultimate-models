_.extend(Ultimate, {
  extends: function (Parent, methods, staticMethods, httpMethods, staticHttpMethods) {
    ...
    this.addStaticBehaviors(); //must be run after all else class configuration since behavior classes may be created here which also use Ultimate.props
