var behaviorMethods; //gonna use this var to add the same methods as static methods too

UltimateBehavior = Ultimate('UltimateBehavior').extends(UltimateFacade, behaviorMethods = {
	abstract: true,
	isBehavior: true,
	ownerContext: false, 
	...
	assignProxyMethod: function(methodName, prop, environment) {
...
delete behaviorMethods.construct;

behaviorMethods.constructBehavior = function(owner) {
	this.mixinTo(owner);
	this._owner = owner;
};

UltimateBehavior.extendStatic(behaviorMethods);