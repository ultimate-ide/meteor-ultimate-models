_.extend(Ultimate, {
  extends: function (Parent, methods, staticMethods, httpMethods) {
    ...
    if(Class.emitBeforeStartup) Class.emitBeforeStartup(); //only UltimateClone, the first extended class, won't have these yet
    if(Class.emitStartup) Class.emitStartup();
